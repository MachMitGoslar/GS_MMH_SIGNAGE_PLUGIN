    ...
    <div class="k-device-management-layout">
      <section class="k-device-management-column k-device-management-panel">
        <div class="k-device-management-header">
          ...
          <p class="k-device-management-copy">
            Freigegebene Displays verwalten, umbenennen und verschieben.
          </p>
        </div>
            ...
            <details class="k-pending-request-details">
              ...
              <div class="k-pending-request-body">
                <div class="k-pending-request-info k-pending-request-info-grid">
                  ...
                  <div class="k-pending-request-field">
                    <span class="k-pending-request-field-label">
                      Genehmigt von
                    </span>
                    <span class="k-pending-request-field-value">
                ...
                <div class="k-device-management-formgrid">
                  <label class="k-device-management-control">
                    <span class="k-device-management-control-label">
                      Gerätename
                    </span>
                    <input
                  ...
                  <label class="k-device-management-control">
                    ...
                    >
                      ...
                      <option
                        v-for="screen in screenOptionsFor(
                          device.uuid,
                          device.screen
                        )"
                        :key="screen.value"
                ...
                <div
                  class="k-pending-request-actions k-pending-request-actions-emphasis"
                >
                  <k-button
                    icon="check"
                    theme="positive"
      ...
      <section class="k-device-management-column">
        <div class="k-device-management-stack">
          <section
            class="k-device-management-section k-device-management-panel"
          >
            <div class="k-device-management-header">
              <k-headline>Ausstehende Anfragen</k-headline>
              <p class="k-device-management-copy">
                Neue Geräte direkt einem Monitor zuordnen oder ablehnen.
              </p>
            </div>
            ...
            <div v-else class="k-pending-requests-table">
              ...
              >
                <details class="k-pending-request-details">
                  ...
                  <div class="k-pending-request-body">
                    <div
                      class="k-pending-request-info k-pending-request-info-grid"
                    >
                      <div class="k-pending-request-field">
                        <span class="k-pending-request-field-label">
                          IP-Adresse
                      ...
                      <div
                        v-if="request.backend"
                        class="k-pending-request-field"
                      >
          ...
          >
            <div class="k-device-management-header">
              ...
              <p class="k-device-management-copy">
                Bereits gesperrte Geräte wieder freigeben oder endgültig
                entfernen.
              </p>
            </div>
                  ...
                  <div class="k-pending-request-body">
                    ...
                    >
                      <div class="k-pending-request-field">
                        ...
                        <span class="k-pending-request-field-value">
                          {{ formatDate(request.last_seen_at) }}
                        </span>
                      </div>
                    </div>
  ...
  data() {
    ...
    return {
      ...
      selectedScreens: {
        ...
        ...Object.fromEntries(approvedItems.map(device => [device.uuid, ''])),
      },
